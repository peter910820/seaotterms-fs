      ...
      <v-col cols="12" md="4" lg="3">
        <v-card class="fs-card folder-picker-card" variant="outlined">
          ...
          <v-card-text class="py-2">
            ...
            <div class="current-path mb-3">{{ pathLabel }}</div>
            <v-list density="compact" class="py-0">
              <v-list-item v-if="parentPath !== null" rounded="lg" class="mb-1" @click="loadPath(parentPath as string)">
                <template #prepend>
...
const { currentDirectories, error, pathLabel, parentPath, loadPath, goIntoFolder } = fileList;
...
const uploadDirectory = computed(() => (fileList.currentPath.value ? fileList.currentPath.value : "."));
